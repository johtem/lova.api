...
{
    public class DocumentTomtModel : PageModel
    {
        private readonly LovaDbContext _context;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IBlobService _blobService;

        public DocumentTomtModel(LovaDbContext context, UserManager<ApplicationUser> userManager, IBlobService blobService)
        {
            _context = context;
