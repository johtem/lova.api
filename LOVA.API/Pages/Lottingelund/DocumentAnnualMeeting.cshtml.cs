...
{
    public class DocumentAnnualMeetingModel : PageModel
    {
        private readonly LovaDbContext _context;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IBlobService _blobService;

        public DocumentAnnualMeetingModel(LovaDbContext context, UserManager<ApplicationUser> userManager, IBlobService blobService)
        {
            _context = context;
        ...
        public async Task<JsonResult> OnPostRead(string target)
        {
            ...
            var lovaDirectories = await _context.UploadFileDirectories
                .Where(a => a.UploadFileCategoryId == 7 && string.IsNullOrEmpty(target) ? a.Directory != target : a.Directory == "apa")
            ...
            var lovaFiles = await _context.UploadedFiles
                .Where(a => a.UploadFileCategoryId == 7 && a.IsDirectory == false && a.Directory == target)
                .Select(a => new ViewFilesViewModel
                {
